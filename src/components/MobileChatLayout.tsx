      ...
      <div className='w-full flex justify-between items-center'>
        <Link
          ...
          className={buttonVariants({ variant: 'ghost' })}>
           <Image src={logoMobile} alt="Chatme" width={45} height={45}/>
        </Link>
                    ...
                    <div className='flex h-full flex-col overflow-hidden bg-white py-6 shadow-xl'>
                      <div className='px-4 sm:px-6'>
                        <div className='flex items-start justify-between'>
                          <Dialog.Title className='text-base font-semibold leading-6 text-[#5E17EB]'>
                            Dashboard
                          </Dialog.Title>
                        ...
                        <nav className='flex flex-1 flex-col'>
                          <ul
                            ...
                            <li className='-ml-6 mt-auto flex items-center'>
                              <div className='flex flex-1 items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-[#5E17EB]'>
